...
export function createProperitesPanel(json, isGeojsonLayer=false) {
    ...
    if (json.hasTimeline) {
        ...
        layerProperty.innerHTML += '<div class="props">'
                             + '<div class="slider-title-panel">'
                             + '<div class="slider-title-first"><h4 class="time-slider-title">' + timeLineData.stepType + (typeof timeLineData.stepOption.prefix === "undefined" ? "" : (" (" + timeLineData.stepOption.prefix + ")") ) + '</h4>'
