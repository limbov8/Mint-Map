...
!function(){
    "use strict";
    window._mintMap = {setOpacity: ()=>{}, onresize: ()=>{}, getLayerNameBySoureLayer:()=>{}, variableArrayCount:0, metadata: [], listOfLayersNotAdded:[], displayed:[], variableArray:[], mapInspect:{}, uiLoaded:false, autocomplete:{}, toggleClass:()=>{}, bounds:[22.4, 3.4, 37.0, 23.2]};
        ...
        function handle_variable() {
            ...
            window._mintMap.displayed.forEach(function (ele,idx) {
                ...
                if (alreadyDisplayed.length === 0) {
                    ...
                    removeLayerFromMap(sourceLayer);
