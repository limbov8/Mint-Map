...
!function(){
    "use strict";
    window._mintMap = {setOpacity: ()=>{}, onresize: ()=>{}, metadata: [], listOfLayersNotAdded:[], variableArray:[], mapInspect:{}, uiLoaded:false, autocomplete:{}, toggleClass:()=>{}, bounds:[22.4, 3.4, 37.0, 23.2]};
